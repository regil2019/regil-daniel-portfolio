...
const Hero = ({ content, currentLanguage }: Props) => {
  return (
    <section
      id="home"
      className="min-h-screen flex flex-col md:flex-row items-center justify-center pt-24 md:pt-8 pb-8 px-4 md:px-6 bg-gradient-to-br from-indigo-900 via-purple-900 to-black"
